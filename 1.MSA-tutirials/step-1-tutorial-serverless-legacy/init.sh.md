...
serverless deploy --aws-profile default --region ap-northeast-2
...
```shell
curl -w "@curl-format.txt" --location --request POST 'https://izldcgxaij.execute-api.ap-northeast-2.amazonaws.com/producer_consumer' \
